...
shared-ld-y     += -lsnappy -lavro -lrdkafka
...
cflags-y	+= -I$(TOPDIR)/libcommon/inc/
cflags-y	+= -I$(TOPDIR)/libtlv/inc/
cflags-y	+= -I$(TOPDIR)/control/inc/
cflags-y	+= -I$(TOPDIR)/libextern/inc/
#engine 
cflags-y	+= -I$(TOPDIR)/ibidding/filter/inc/
cflags-y	+= -I$(TOPDIR)/ibidding/liblinear-1.96/
cflags-y	+= -I$(TOPDIR)/ibidding/engine/inc/
cflags-y	+= -I$(TOPDIR)/ibidding/inc/
