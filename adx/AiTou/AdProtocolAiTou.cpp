...
int AdProtocolAiTou::HttpToInternal(AdAdapterPara * pPara)
{
	int iCount = 0;
	int iFloorPrice = 0;
...
int AdProtocolAiTou::InternalToHttp(AdAdapterPara * pPara)
{
	int iLength = 0;
	int ret;
...
int AdProtocolAiTou::EmptyToHttp(AdAdapterPara * pPara)
{
...
{
	AdProtocolAiTou *  pPro = new AdProtocolAiTou;
	if(pPro == NULL)
	{
